 ...
 <section class="section background-dark">
      ...
      <section class="padding background-dark">
        <div class="line">
          <div class="s-12 l-6">
            <p class="text-size-12">Copyright <?php echo date('Y'); ?>, Kaung San Hein (CS)</p>
          </div>
          <div class="s-12 l-6">
            <a class="right text-size-12" href="http://www.myresponsee.com" title="Responsee - lightweight responsive framework">Design and coding<br> by Kaung San Hein (CS)</a>
          </div>
        </div>
      </section>
    </footer> 
